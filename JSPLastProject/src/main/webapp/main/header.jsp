...
function loadNews() {
  ...
  xhr.open("GET", "../news/list.do", true);
  ...
  xhr.onreadystatechange = function() {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      ticker.textContent = xhr.responseText;
    }
  };
    ...
    <header class="header_area">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div id="ticker-box">
                      <span id="ticker"><공사>::정릉천자전거길::마장IC::마장IC::1차로::[공사]2025 자동차전용도로 시설물4지역 일상유지보수공사/장소: 정릉천고가교 마장진입,진출램프/ 통제방법: 부분통제::도로공사 서울청</span>
                     </div>
                </div>
            </div>
        </div>
